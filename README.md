...
Fazer um algoritmo, em Java, utilizando a biblioteca PilhaInt (https://github.com/bianca-efs/Estudo.de.Pilhas_Criacao.de.biblioteca), inicializar uma pilha de inteiros e resolva conforme
as condições:
